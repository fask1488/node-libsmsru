...
var api_id = '00000000-0000-0000-0000-000000000000';
...
//
sms.send('79150000000', 'Пример SMS-сообщения', { from: 'xinit.ru' }, function(err, answer) {
    ...
    if (err == null) {
        var int = setInterval(function() {
            ...
            sms.status(answer.smsId[0], function(err, ans) {
                console.log(err, ans);
